...
export default function ItemDetailContainer() {
    ...
    useEffect(() => {
        ...
        {id:4, talle:[5 , 5.5 , 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10.5, 11], title:"Nike Air Max 90", price:200, img:"https://static.nike.com/a/images/t_default/yo8q4g51so6rylfl6w14/air-max-90-mens-shoes-6n3vKB.png"}];
    new Promise((resolve)=>{
        setTimeout(()=>{
